...
# args
imgs_path = r"D:/python_codes/MmSAM/dataset/ISPRS/val/label/"  # dir containing large size images to be cropped
save_imgs_path = r"D:/python_codes/MmSAM/dataset/ISPRS/val/crop/label/"  # dir to save cropped images
is_graylabel = False  # whether the path is grayscale label images
size = 1024  # cropped size
img_type = 'jpg'  # the format in which the images are saved
overlap = 0.025  # the overlap ratio of crop patches    Potsdam[0.025, 0.025, 0.025]  whu[0.1, 0.1, 0.1]

imgs_dir = os.listdir(imgs_path)
# with open(imgs_path + "val.txt", 'r', encoding='utf-8') as file:
#     imgs_dir = file.readlines()
# imgs_dir = [r"D:/python_codes/MmSAM/dataset/whu-opt-sar/" + line.strip() for line in imgs_dir]
